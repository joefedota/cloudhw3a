...
/*YOUR CODE HERE*/
var credentialsArr []Credentials = []Credentials{}
...
func signup(response http.ResponseWriter, request *http.Request) {
	...
	*/
	...
	credentialsArr = append(credentialsArr, credentials)
...
func getIndex(response http.ResponseWriter, request *http.Request) {
	...
	*/
	...
	for i := 0; i < len(credentialsArr); i++ {
		if credentialsArr[i].Username == credentials.Username {
...
func getPassword(response http.ResponseWriter, request *http.Request) {
	...
	*/
	...
	for i := 0; i < len(credentialsArr); i++ {
		if credentialsArr[i].Username == credentials.Username {
			fmt.Fprintf(response, credentialsArr[i].Password)
			return
		}
	}
...
func updatePassword(response http.ResponseWriter, request *http.Request) {
	...
	*/
	...
	for i := 0; i < len(credentialsArr); i++ {
		if credentialsArr[i].Username == credentials.Username {
			credentialsArr[i].Password = credentials.Password
			return
		}
	}
...
func deleteUser(response http.ResponseWriter, request *http.Request) {
	...
	*/
	...
	for i := 0; i < len(credentialsArr); i++ {
		if credentialsArr[i].Username == credentials.Username && credentialsArr[i].Password == credentials.Password {
			credentialsArr = remove(credentialsArr, i)
			return
		}
	}
